...
## Data Sources
The Wikipedia artifacts that are mapped to DiscourseDB are based on an automatic segmentation of the page contents. They do not have idenfiers in the original source. Therefore, we are generatign ids for each entity.
