...
All DiscourseDB projects require Java 8+ and Maven 3. More information about the setup can be found in the [DiscourseDB wiki](https://github.com/DiscourseDB/discoursedb-core/wiki/General-Info-and-Setup).
