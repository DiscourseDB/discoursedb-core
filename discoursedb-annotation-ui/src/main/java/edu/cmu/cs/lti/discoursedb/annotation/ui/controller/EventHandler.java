...
public class EventHandler {
	...
	@HandleAfterCreate
	public void newEmployee(Contribution contribution) {
		this.websocket.convertAndSend(
				MESSAGE_PREFIX + "/newContribution", getPath(contribution));
	}

	@HandleAfterDelete
	public void deleteEmployee(Contribution contribution) {
		this.websocket.convertAndSend(
				MESSAGE_PREFIX + "/deleteContribution", getPath(contribution));
	}

	@HandleAfterSave
	public void updateEmployee(Contribution contribution) {
		this.websocket.convertAndSend(
