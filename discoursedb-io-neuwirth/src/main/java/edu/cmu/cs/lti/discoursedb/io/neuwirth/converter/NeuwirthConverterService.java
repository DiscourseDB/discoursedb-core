...
@Service
//@Configuration
//@ComponentScan("edu.cmu.cs.lti.discoursedb.io.neuwirth.converter.NeuwirthConverterService")
...
public class NeuwirthConverterService {
	...
	public void mapFile(String dataSetName, String filePath, String fileName) throws IOException, ParseException {
